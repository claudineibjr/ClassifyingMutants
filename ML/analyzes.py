...
if __name__ == '__main__':
	...
	programsBestMetrics = analyzeMetricsFromProgram(programsInfo, possibleClassifiers, plot=True)

	#analyzeClassifiersProgramAProgram(programsInfo, possibleClassifiers, plot=True)
